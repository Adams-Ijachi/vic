                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <center><form method="POST" action="notifications.php">
                                      ...
                                      <input class="form-control" readonly="" type="text" name="recipient" value="The Request was From Mr/Mrs.<?php echo $rows['customer_name']; ?>">
                                      </div>
									  <div class="form-group">
									  <input class="form-control" type="text" name="recipient" value="" placeholder="Please Enter Road Police Number" required>
									  </div>
                           <div class="form-group">
