      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Send Response">
          <a class="nav-link" href="roadpolice.php">
            <i class="fa fa-fw fa-send"></i>
            <span class="nav-link-text">Send sms Road Police</span>
          </a>
        </li>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Notify Road Police Through SMS</li>
      </ol>
      <div class="row">
        <div class="col-12">
                    ...
                    <div class="panel-body">
                      <center><form method="POST" action="#">
                           ...
                           <div class="form-group">
                                            ...
                                            <input name="plaque"type="text" class="form-control" id="inputPage" placeholder="Enter Telephone Number" required>
                                        </div>
                                        <div class="form-group">
                                            <textarea name="plaque"type="text" class="form-control" id="inputPage" placeholder="Type Message Body Here" required></textarea>
                                        </div>
                        <div class="form-group">
                          <div class="col-md-offset-2 col-md-10">
                            <button class="btn btn-info" type="submit" name="submit"><i class="fa fa-fw fa-info"></i> <i>Send Message</i> </button>
