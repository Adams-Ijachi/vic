...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html">Vehicle Investigation System / RRA VEHICLE TAXES</a>
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="dashboard.php">Dashboard</a> / Tax Overview
        </li>     
      </ol>
      ...
      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-primary o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">Total Car Not Pay Taxes</span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">Total Vehicle in Tax Pending</span>
              <span class="float-right">
                <i class="fa fa-car"></i>
              </span>
            </a>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">Total Vehicle Pay Taxes</span>
              <span class="float-right">
                <i class="fa fa-car"></i>
              </span>
            </a>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-danger o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left"><h6>Total Vehicle Registered</h6></span>
              <span class="float-right">
                <i class="fa fa-car"></i>
              </span>
            </a>
