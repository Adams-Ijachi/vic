...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
   ...
   <?php 
   include 'dbcon.php';
   $sql = $conn ->prepare("SELECT COUNT(Id) as mi FROM  messagein");
                                           $sql -> execute();
                                           $count = $sql->fetchAll(); 
                                           foreach ($count as $field);
                                           ?>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="View Requests">
          <a class="nav-link" href="sms_request.php">
            ...
            <span class="nav-link-text">Phone SMS Requests    <span class="badge" style="background-color: darkred;"><?php echo $field['mi'];?></span>
          </a>
        </li>
   ...
   $sql = $conn ->prepare("SELECT COUNT(seen_status) as tr FROM  requests WHERE seen_status=2");
		 ...
		 <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Send Response">
          <a class="nav-link" href="traffics.php">
            ...
            <span class="nav-link-text">Traffic Response  <span class="badge" style="background-color: purple;"><?php echo $field['tr'];?></span>
          </a>
        </li>
		   <?php 
   include 'dbcon.php';
...
<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Send Response">
          <a class="nav-link" href="Report.php">
            ...
            <span class="nav-link-text">Requests Report</span>
          </a>
        </li>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Total Cars Responded <h2>(<?php echo $field['m']?>)</h2></div>
            </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Total Cars In Investigation <h2>(<?php echo $field['m']?>)</h2></div>
            </div>
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright &copy; <?php echo date('Y'); ?> Vehicle Investigation System</small>
        </div>
      </div>
    </footer>
